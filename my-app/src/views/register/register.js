      ...
      <div className="all_main">
        ...
        <main className="register_main">
          <figure className="img_register">
            ...
            <figcaption className="big_text_registration">
              <span className="big_text_color">Rejoins</span>-Nous
              <br />
              <span className="small_text_registration">
                Ça donne du chien !
              </span>
            </figcaption>
          </figure>
          <form onSubmit={e => this.handleSubmit(e)} className="form_register">
            <div className="inputs_register">
              <label>
                ...
                <span>
                  {' '}
                  {this.state.validation === 'firstNameNotValid'
                    ? 'Veuillez entrer votre nom'
                    : '' || this.state.validation === 'allNotValid'
                    ? 'Veuillez entrer votre nom'
                    : ''}{' '}
                </span>
              </label>
              <label>
                ...
                <span>
                  {' '}
                  {this.state.validation === 'lastNameNotValid'
              ...
              <label>
                ...
                <span>
                  {' '}
                  {this.state.validation === 'passwordNotValid'
