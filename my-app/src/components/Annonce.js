        ...
        return (
           <div className="annonce_main">
               ...
               <div className="user_trajet_annonce">
                    <img src={require("../image/user.png")} className="img_annonce" id="user_img_annonce"></img>
                    <p id="username_annonce">Sarah</p>
                    <img src={require("../image/dogicon.png")} className="img_annonce"></img>
                    <img src={require("../image/cat.png")} className="img_annonce"></img>
                    <p>x3</p>
                </div>
